 ...
 */
(function() {
  const API_URL = "https://script.google.com/macros/s/AKfycbzLxq0jgfrgMeEjHE8cx8Lsf4oX89FdA64jl1tXI52KgtpDu0fj8o6GX4JcwYPH-J8/exec";
  ...
  function applyUpdate(shop) {
    ...
    if (catchEl && shop["詳細、本文"]) {
      catchEl.innerHTML = `<span style="display:block; color:#e67e22; font-weight:900; margin-bottom:8px;">★ 最新のお知らせ ★</span>${shop["詳細、本文"]}`;
    }

    // 2. メインタイトルの下に「今回の見どころ」を追加
    const headEl = document.querySelector('.shop-head');
    if (headEl && shop["メインタイトル"]) {
       ...
       subTitle.textContent = shop["メインタイトル"];
